...
typedef struct CPUAction {
  ...
  unsigned char stickDir : 3; // 0 = none, 1 = towards opponent, 2 = away from
                              // opponent, 3 = forward, 4 = backward
} CPUAction;
...
// an attack that would have otherwise knocked you into the air without
// knockdown. This doesn't occur with rolls for some reason.
...
static CPUAction *Lab_CPUActions[] = {0,
                                      &Lab_CPUActionShield,
                                      &Lab_CPUActionGrab,
                                      &Lab_CPUActionUpB,
...
static u8 CPUCounterActionsGround[] = {
    CPUACT_NONE,          CPUACT_SPOTDODGE,
    CPUACT_SHIELD,        CPUACT_GRAB,
    CPUACT_UPB,           CPUACT_SIDEBTOWARD,
    CPUACT_SIDEBAWAY,     CPUACT_DOWNB,
    CPUACT_NEUTRALB,      CPUACT_USMASH,
    CPUACT_DSMASH,        CPUACT_FSMASH,
    CPUACT_ROLLAWAY,      CPUACT_ROLLTOWARDS,
    CPUACT_ROLLRDM,       CPUACT_NAIR,
    CPUACT_FAIR,          CPUACT_DAIR,
    CPUACT_BAIR,          CPUACT_UAIR,
    CPUACT_JAB,           CPUACT_FTILT,
    CPUACT_UTILT,         CPUACT_DTILT,
    CPUACT_SHORTHOP,      CPUACT_FULLHOP,
    CPUACT_WAVEDASH_AWAY, CPUACT_WAVEDASH_TOWARDS,
    CPUACT_WAVEDASH_DOWN};

static u8 CPUCounterActionsAir[] = {
    CPUACT_NONE,        CPUACT_AIRDODGE, CPUACT_JUMPAWAY,    CPUACT_JUMPTOWARDS,
    CPUACT_JUMPNEUTRAL, CPUACT_UPB,      CPUACT_SIDEBTOWARD, CPUACT_SIDEBAWAY,
    CPUACT_DOWNB,       CPUACT_NEUTRALB, CPUACT_NAIR,        CPUACT_FAIR,
    CPUACT_DAIR,        CPUACT_BAIR,     CPUACT_UAIR,        CPUACT_FFTUMBLE,
    CPUACT_FFWIGGLE};

static u8 CPUCounterActionsShield[] = {
    CPUACT_NONE,         CPUACT_GRAB,          CPUACT_SHORTHOP,
    CPUACT_FULLHOP,      CPUACT_SPOTDODGE,     CPUACT_ROLLAWAY,
    CPUACT_ROLLTOWARDS,  CPUACT_ROLLRDM,       CPUACT_USMASHOOS,
    CPUACT_UPB,          CPUACT_DOWNB,         CPUACT_NAIR,
    CPUACT_FAIR,         CPUACT_DAIR,          CPUACT_BAIR,
    CPUACT_UAIR,         CPUACT_WAVEDASH_AWAY, CPUACT_WAVEDASH_TOWARDS,
    CPUACT_WAVEDASH_DOWN};

static char *LabValues_CounterGround[] = {
    "None",         "Spotdodge",     "Shield",        "Grab",
    "Up B",         "Side B Toward", "Side B Away",   "Down B",
    "Neutral B",    "Up Smash",      "Down Smash",    "Forward Smash",
    "Roll Away",    "Roll Towards",  "Roll Random",   "Neutral Air",
    "Forward Air",  "Down Air",      "Back Air",      "Up Air",
    "Jab",          "Forward Tilt",  "Up Tilt",       "Down Tilt",
    "Short Hop",    "Full Hop",      "Wavedash Away", "Wavedash Towards",
    "Wavedash Down"};
static char *LabValues_CounterAir[] = {
    "None",           "Airdodge",  "Jump Away",     "Jump Towards",
    "Jump Neutral",   "Up B",      "Side B Toward", "Side B Away",
    "Down B",         "Neutral B", "Neutral Air",   "Forward Air",
    "Down Air",       "Back Air",  "Up Air",        "Tumble Fastfall",
    "Wiggle Fastfall"};
static char *LabValues_CounterShield[] = {
    "None",         "Grab",          "Short Hop",
    "Full Hop",     "Spotdodge",     "Roll Away",
    "Roll Towards", "Roll Random",   "Up Smash",
    "Up B",         "Down B",        "Neutral Air",
    "Forward Air",  "Down Air",      "Back Air",
    "Up Air",       "Wavedash Away", "Wavedash Towards",
    "Wavedash Down"};
...
static char *LabValues_InfoDisplay[INFDISP_COUNT] = {"None",
                                                     "Position",
                                                     "State Name",
                                                     "State Frame",
                                                     "Velocity - Self",
...
static char *LabValues_ShieldDir[] = {"Neutral", "Up", "Towards", "Down",
                                      "Away"};
static char *LabValues_CPUBehave[] = {"Stand", "Shield", "Crouch", "Jump"};
static char *LabValues_TDI[] = {"Random", "Inwards",       "Outwards",
                                "Custom", "Random Custom", "None"};
static char *LabValues_ASDI[] = {"Auto",  "Away", "Towards", "Left",
                                 "Right", "Up",   "Down"};
static char *LabValues_SDIDir[] = {"Random", "Away", "Towards", "Up",
                                   "Down",   "Left", "Right"};
static char *LabValues_Tech[] = {"Random", "Neutral", "Away", "Towards",
                                 "None"};
static char *LabValues_Getup[] = {"Random", "Stand", "Away", "Towards",
                                  "Attack"};
...
static EventOption LabOptions_CPU[OPTCPU_COUNT] = {
    ...
    },
    {
        ...
        .desc =
            "Select the action to be performed after the\nCPU's shield is hit.",
    ...
    },
    {
        ...
        .desc =
            "Adjust the amount of actionable frames before \nthe CPU counters.",
        .option_values = "%d Frames",
    },
    {
        .option_kind = OPTKIND_INT,
...
// The option idx will be serialized when exported, so loading older replays
// could load the wrong option if we reorder/remove options.
static char *LabValues_RecordSlot[] = {"Random", "Slot 1", "Slot 2", "Slot 3",
                                       "Slot 4", "Slot 5", "Slot 6"};
static char *LabValues_HMNRecordMode[] = {"Off", "Record", "Playback"};
static char *LabValues_CPURecordMode[] = {"Off", "Control", "Record",
                                          "Playback"};
...
static char *LabValues_OverlayNames[OVERLAY_COLOUR_COUNT] = {
    ...
    "White", "Black", "Remove Overlay", "Invisible", "Play Sound"};
...
static Overlay LabValues_OverlayColours[OVERLAY_COLOUR_COUNT] = {
    {.color = {0, 0, 0, 0}},           {.color = {255, 20, 20, 180}},
    {.color = {20, 255, 20, 180}},     {.color = {20, 20, 255, 180}},
    {.color = {220, 220, 20, 180}},    {.color = {255, 255, 255, 180}},
    {.color = {20, 20, 20, 180}},

    {.color = {0, 0, 0, 0}},           {.invisible = 1},
